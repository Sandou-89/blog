...
<nav class="navbar navbar-light bg-success">
  <a class="navbar-brand mb-0 h1 pro text-light" href="index.php">JC COFFEE-SHOP</a>
  ...
  <footer class="py-5 bg-transparent">
    <div class="container">
      <p class="m-0 text-center text-black">Copyright &copy; coffee 2020</p>
    </div>
    <!-- /.container -->
  </footer>
</body>
